    ...
    <footer className="bg-[#0D0D0D] font-inter text-white">
        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <div className="font-playfair text-sm font-bold leading-tight">
                  Golden Gatherings
                </div>
                <div className="mt-0.5 text-[8px] uppercase tracking-[2.5px] text-[#F7C948]">
            ...
            <p className="max-w-[240px] text-xs leading-relaxed text-[#888]">
              Your official gateway to every academic forum, cultural night,
              sporting event, and celebration happening across the Royal
          ...
          {/* Links Columns */}
          <div>
            <div className="mb-4 border-b border-[#1e1e1e] pb-2 text-[9px] font-bold uppercase tracking-[3px] text-[#F7C948]">
              Navigate
            </div>
            <div className="flex flex-col text-[#888]">
              <a
                href="#"
                className="group flex items-center justify-between border-b border-[#161616] py-2 text-xs transition-colors hover:text-[#F7C948]"
              >
                Home{" "}
                <span className="text-[10px] text-[#333] transition-colors group-hover:text-[#F7C948]">
                  ›
                </span>
              </a>
              <a
          ...
          <div className="space-y-4">
            ...
            <div className="bg-[#111] p-[14px]">
              <div className="mb-1 text-[8px] font-bold uppercase tracking-[2px] text-[#F7C948]">
                Stay in the loop
              </div>
              <div className="mb-2.5 text-[11px] text-[#888]">
                Get event alerts straight to your UST inbox.
              </div>
              <form className="flex">
                <input
                  type="email"
                  placeholder="yourname@ust.edu.ph"
                  className="min-w-0 flex-1 border border-r-0 border-[#2a2a2a] bg-[#1a1a1a] px-2.5 py-[7px] text-[11px] outline-none focus:border-[#F7C948]"
                />
                <button
                  type="button"
                  className="bg-[#F7C948] px-3 py-[7px] text-[11px] font-bold text-[#0D0D0D] transition-colors hover:bg-[#e0aa00]"
                >
                  Subscribe
                </button>
              </form>
      ...
      <div className="border-t border-[#1a1a1a] px-10 py-6">
        <div className="flex flex-col items-center justify-between gap-8 lg:flex-row">
          <div className="flex flex-wrap gap-8">
            <div className="flex items-center gap-8">
              <div className="text-center md:text-left">
                <div className="font-playfair text-lg font-bold text-[#F7C948]">
                  412
                </div>
          ...
          <div className="font-playfair text-[13px] italic tracking-wide text-[#444]">
            Veritas in Caritate
          </div>
          <div className="flex gap-1.5">
            <span className="border border-[#222] bg-[#111] px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[1.5px] text-[#555]">
              ISO Certified
            </span>
            <span className="border border-[#222] bg-[#111] px-2.5 py-1 text-[9px] font-semibold uppercase tracking-[1.5px] text-[#555]">
              CHED Recognized
      ...
      <div className="flex flex-col items-center justify-between border-t border-[#161616] px-10 py-4 lg:flex-row">
        <div className="flex flex-wrap items-center justify-center gap-5">
          <div className="text-[11px] text-[#444]">
            © 2026 <span className="text-[#F7C948]">Golden Gatherings</span> ·
            University of Santo Tomas
          </div>
          <div className="flex gap-[18px]">
            <a
              href="#"
              className="text-[11px] text-[#444] hover:text-[#F7C948]"
            >
              Privacy Policy
            </a>
            <a
        ...
        <div className="mt-4 flex items-center gap-2.5 lg:mt-0">
          <div className="text-[11px] text-[#333]">
            Powered by the Office of Student Affairs & Missions
          </div>
          <button
            onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
            className="flex items-center gap-1.5 border border-[#222] bg-[#1a1a1a] px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-[#888] transition-colors hover:border-[#F7C948] hover:text-[#F7C948]"
          >
            <svg
              className="h-[11px] w-[11px] fill-none stroke-current stroke-2"
              viewBox="0 0 12 12"
            >
